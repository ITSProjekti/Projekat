namespace ITS_Pravi_Projekat.Migrations
{
    ...
    public partial class InicijalniModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        ImeRoditelja = c.String(nullable: false, maxLength: 50),
                        JMBG = c.Long(nullable: false),
                        DatumRodjenja = c.DateTime(nullable: false),
                        BrojLicneKarte = c.Long(nullable: false),
                        Beleska = c.String(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.Pols", t => t.PolId, cascadeDelete: true)
                .Index(t => t.PolId);
